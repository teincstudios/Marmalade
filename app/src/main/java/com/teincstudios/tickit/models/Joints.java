...
public class Joints implements Parcelable{
    ...
    public Joints(String spotName, String spotImageUrl, String spotRating, String spotLocation, String cuisines, int priceLevel, String cost, Boolean openStatus, String openingTime, String closingTime, ArrayList photosList, Boolean isTrending){
    ...
    public String getDistance() {
        ...
        return String.valueOf(RestaurantUtils.round(distanceInKm, 1)).concat(unit).concat("from here");
    }
